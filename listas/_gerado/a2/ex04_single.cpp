...
int main() {
    No::total_vivos = 0;
    {
        ...
        p.empilha("colar");
        p.empilha("apagar");
        VERIFICA_IGUAL(No::total_vivos, 3);
        VERIFICA_IGUAL(p.desfaz(), std::string("apagar"));
        VERIFICA_IGUAL(p.desfaz(), std::string("colar"));
        VERIFICA_IGUAL(No::total_vivos, 1);
        VERIFICA_IGUAL(p.desfaz(), std::string("digitar"));
    }
