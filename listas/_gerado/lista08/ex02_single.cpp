...
int main() {
    ...
    t.registra(25.0);
    t.registra(15.0);
    VERIFICA_PERTO(t.atual(), 15.0, 0.0001);
    VERIFICA_PERTO(t.minimo(), 15.0, 0.0001);
    VERIFICA_PERTO(t.maximo(), 25.0, 0.0001);

    Termometro t2(10.0);
    VERIFICA_PERTO(t2.atual(), 10.0, 0.0001);
    VERIFICA_PERTO(t2.minimo(), 10.0, 0.0001);
    VERIFICA_PERTO(t2.maximo(), 10.0, 0.0001);
