...
int main() {
    ...
    VERIFICA_PERTO(r1.area(), 12.0, 0.0001);
    VERIFICA_IGUAL(r1.eh_quadrado(), false);

    RetanguloValidado r2(-5.0, 5.0);
    VERIFICA_PERTO(r2.area(), 0.0, 0.0001);

    RetanguloValidado r3(5.0, 5.0);
    VERIFICA_IGUAL(r3.eh_quadrado(), true);
    VERIFICA_PERTO(r3.perimetro(), 20.0, 0.0001);
