...
// ============================================================
int main() {
    VERIFICA_IGUAL(inverte("abc"), std::string("cba"));
    VERIFICA_IGUAL(inverte("ana"), std::string("ana"));
    VERIFICA_IGUAL(inverte(""), std::string(""));
    VERIFICA_IGUAL(inverte("a"), std::string("a"));
    VERIFICA_IGUAL(inverte("cpp"), std::string("ppc"));
    RESUMO_TESTES();
}
