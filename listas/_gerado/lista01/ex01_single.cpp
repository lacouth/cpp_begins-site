...
// ============================================================
int main() {
    VERIFICA_IGUAL(saudacao("Maria"), std::string("Ola, Maria!"));
    VERIFICA_IGUAL(saudacao("Joao"), std::string("Ola, Joao!"));
    VERIFICA_IGUAL(saudacao(""), std::string("Ola, !"));
    VERIFICA_IGUAL(saudacao("Ana Paula"), std::string("Ola, Ana Paula!"));
    RESUMO_TESTES();
}
