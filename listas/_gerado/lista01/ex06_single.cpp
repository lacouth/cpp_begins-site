...
// ============================================================
int main() {
    VERIFICA_IGUAL(eh_palindromo("arara"), true);
    VERIFICA_IGUAL(eh_palindromo("ovo"), true);
    VERIFICA_IGUAL(eh_palindromo("banana"), false);
    VERIFICA_IGUAL(eh_palindromo(""), true);
    VERIFICA_IGUAL(eh_palindromo("a"), true);
    RESUMO_TESTES();
}
