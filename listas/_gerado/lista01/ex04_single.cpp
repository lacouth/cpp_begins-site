...
// ============================================================
int main() {
    VERIFICA_IGUAL(conta_vogais("banana"), 3);
    VERIFICA_IGUAL(conta_vogais("Programacao"), 5);
    VERIFICA_IGUAL(conta_vogais("xyz"), 0);
    VERIFICA_IGUAL(conta_vogais(""), 0);
    VERIFICA_IGUAL(conta_vogais("AEIOU"), 5);
    RESUMO_TESTES();
}
