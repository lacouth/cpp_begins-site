...
int main() {
    ...
    VERIFICA_IGUAL(r1.size(), static_cast<std::size_t>(2));
    VERIFICA_IGUAL(r1[0].nome, std::string("Ana"));
    VERIFICA_IGUAL(r1[0].idade, 25);
    VERIFICA_IGUAL(r1[1].nome, std::string("Bruno"));
    VERIFICA_IGUAL(r1[1].idade, 30);
