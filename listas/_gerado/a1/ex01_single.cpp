...
int main() {
    ...
    VERIFICA_PERTO(precos[0], 90.0, 0.0001);
    VERIFICA_PERTO(precos[1], 45.0, 0.0001);

    aplica_desconto(precos, 50.0);
    VERIFICA_PERTO(precos[0], 45.0, 0.0001);
    VERIFICA_PERTO(precos[1], 22.5, 0.0001);

    std::vector<double> zero = {10.0};
    aplica_desconto(zero, 0.0);
    VERIFICA_PERTO(zero[0], 10.0, 0.0001);
