...
int main() {
    ...
    m.adiciona("corda");
    m.adiciona("lanterna");
    VERIFICA_IGUAL(m.tamanho(), 2);
    VERIFICA_IGUAL(m.contem("corda"), true);
    VERIFICA_IGUAL(m.contem("faca"), false);

    Mochila copia = m;
    copia.adiciona("faca");
    VERIFICA_IGUAL(m.tamanho(), 2);
    VERIFICA_IGUAL(copia.tamanho(), 3);
    VERIFICA_IGUAL(m.contem("faca"), false);
    VERIFICA_IGUAL(copia.contem("faca"), true);
