...
// ============================================================
int main() {
    VERIFICA_PERTO(preco_final(100.0), 110.0, 0.0001);
    VERIFICA_PERTO(preco_final(100.0, 1.0), 100.0, 0.0001);
    VERIFICA_PERTO(preco_final(200.0, 1.5), 300.0, 0.0001);
    VERIFICA_PERTO(preco_final(0.0), 0.0, 0.0001);
    RESUMO_TESTES();
}
