...
// ============================================================
int main() {
    VERIFICA_IGUAL(dobro(5), 10);
    VERIFICA_IGUAL(dobro(0), 0);
    VERIFICA_IGUAL(dobro(-3), -6);
    VERIFICA_PERTO(dobro(2.5), 5.0, 0.0001);
    VERIFICA_PERTO(dobro(0.0), 0.0, 0.0001);
    VERIFICA_PERTO(dobro(-1.5), -3.0, 0.0001);
    RESUMO_TESTES();
}
