...
// ============================================================
int main() {
    VERIFICA_IGUAL(repete("ab", 3), std::string("ababab"));
    VERIFICA_IGUAL(repete("x", 0), std::string(""));
    VERIFICA_IGUAL(repete("oi", 1), std::string("oi"));
    VERIFICA_IGUAL(repete("", 5), std::string(""));
    RESUMO_TESTES();
}
