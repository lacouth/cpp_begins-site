...
// ============================================================
int main() {
    VERIFICA_IGUAL(existe_negativo({1, -2, 3}), true);
    VERIFICA_IGUAL(existe_negativo({1, 2, 3}), false);
    VERIFICA_IGUAL(existe_negativo({}), false);
    VERIFICA_IGUAL(existe_negativo({-1}), true);
    RESUMO_TESTES();
}
