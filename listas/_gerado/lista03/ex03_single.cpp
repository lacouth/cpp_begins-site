...
int main() {
    ...
    VERIFICA_IGUAL(r1.first, 3);
    VERIFICA_IGUAL(r1.second, 9);

    auto r2 = min_max(-1, -5, 0);
    VERIFICA_IGUAL(r2.first, -5);
    VERIFICA_IGUAL(r2.second, 0);

    auto r3 = min_max(4, 4, 4);
    VERIFICA_IGUAL(r3.first, 4);
    VERIFICA_IGUAL(r3.second, 4);
