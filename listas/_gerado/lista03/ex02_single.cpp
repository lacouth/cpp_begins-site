...
// ============================================================
int main() {
    VERIFICA_IGUAL(nome_turno(Turno::Manha), std::string("Manha"));
    VERIFICA_IGUAL(nome_turno(Turno::Tarde), std::string("Tarde"));
    VERIFICA_IGUAL(nome_turno(Turno::Noite), std::string("Noite"));
    RESUMO_TESTES();
}
