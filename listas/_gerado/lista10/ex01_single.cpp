...
int main() {
    PilhaComVector p;
    VERIFICA_IGUAL(p.vazia(), true);
    p.empilha(1);
    p.empilha(2);
    p.empilha(3);
    VERIFICA_IGUAL(p.vazia(), false);
    VERIFICA_IGUAL(p.desempilha(), 3);
    VERIFICA_IGUAL(p.topo(), 2);
    VERIFICA_IGUAL(p.desempilha(), 2);
    VERIFICA_IGUAL(p.desempilha(), 1);
    VERIFICA_IGUAL(p.vazia(), true);
